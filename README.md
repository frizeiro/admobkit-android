...
```gradle
dependencies {
    implementation 'com.github.frizeiro:admobkit-android:0.2.0'
}
```
...
Add the dependency
```gradle
libraryDependencies += "com.github.frizeiro" % "admobkit-android" % "0.2.0"
```
...
Add the dependency
```gradle
:dependencies [[com.github.frizeiro/admobkit-android "0.2.0"]]
```
